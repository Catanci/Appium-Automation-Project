...
public class ProductPage {
    ...
    @AndroidFindBy(xpath = "//android.view.View[@content-desc='View in cart']")
    private WebElement viewCartButton;

    //Cart Overlay
    @AndroidFindBy(xpath = "//android.app.Dialog[@text='1 item added to cart']/android.view.View/android.view.View[2]/android.widget.TextView[@text]")
