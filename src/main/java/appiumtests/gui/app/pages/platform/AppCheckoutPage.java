...
public class AppCheckoutPage extends ApkCheckoutPageBase {
    ...
    private final Logger logger = LogManager.getLogger(AppCheckoutPage.class);

    public AppCheckoutPage(AppiumDriver driver) {
        super(driver);
