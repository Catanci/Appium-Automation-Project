...
public class DriverConstants {
    ...
    public static final String ANDROID_PLATFORM_NAME = getDeviceConfig("ios_automation_name");
    ...
    public static final String ANDROID_APP = getDeviceConfig("android_app_path");
    ...
    public static final String IOS_APP = getDeviceConfig("ios_app_path");
